...
public class Blog extends Activity {
	...
	private void setListener() {
		...
		mShare.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Toast.makeText(Blog.this, "暂时无法提供此功能", Toast.LENGTH_SHORT)
						.show();
			}
		});
